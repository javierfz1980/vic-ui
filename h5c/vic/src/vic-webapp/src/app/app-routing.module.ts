...
const appRoutes: Routes = [
    ...
    { path: 'configure-vch-view', loadChildren: './configure/configure-vch-view/configure-vch-view.module#ConfigureVchViewModule' },
    { path: 'configure-vch-modal', loadChildren: './configure/configure-vch-modal/configure-vch-modal.module#ConfigureVchModalModule' },
