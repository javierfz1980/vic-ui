...
export class VchNetworkComponent extends VchComponentBase implements OnInit {
  ...
  protected updateCurrentModel() {
    if (this.form.valid || this.readOnly) {
      ...
      this.model.publicNetworkType = this.form.get('publicNetworkType').value;
      ...
      if (this.form.get('dnsServer').value) {
        this.model.dnsServer = Array.isArray(this.form.get('dnsServer').value) ?
      ...
      if (this.inAdvancedMode) {
        ...
        if (this.form.get('clientNetwork').value) {
          ...
          this.model.clientNetworkType = this.form.get('clientNetworkType').value;
        ...
        if (this.form.get('managementNetwork').value) {
          ...
          this.model.managementNetworkType = this.form.get('managementNetworkType').value;
        ...
        this.model.containerNetworks = [];
        this.model.clientNetworkType = '';
        this.model.managementNetworkType = '';
      }
